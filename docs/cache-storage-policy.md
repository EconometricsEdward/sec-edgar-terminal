...
The site uses the existing Supabase project `vvkihuduqqnxqahhbphs` for shared public research data. Redis retains small operational counters, leases, cooldowns and the existing fenced pilot mirrors. No additional project or paid resource is introduced.
