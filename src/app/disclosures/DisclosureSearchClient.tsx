...
export default function DisclosureSearchClient({ initialQuery = '' }: { initialQuery?: string }) {
  ...
  return (
    <>
      ...
      <DisclosureScanner initialQuery={initialQuery} onScanComplete={handleScanComplete} />
