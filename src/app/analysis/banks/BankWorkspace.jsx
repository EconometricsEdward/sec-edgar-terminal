...
export default function BankWorkspace({ initialState, rssd, options, error }) {
  ...
  return <div className={`${styles.page} ${options.view==='compare'?styles.comparePage:''}`}>
