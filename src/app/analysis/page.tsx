    ...
    <>
      ...
      <div className="border-2 border-dashed border-stone-800 p-12 text-center">
        ...
        <p className="text-stone-600 text-xs max-w-md mx-auto">
          ...
          with filing markers, material event radar, quarterly momentum, expense discipline, profitability bridge, earnings quality, growth durability, per-share economics, capital efficiency, asset composition, balance sheet risk, cash conversion, payout coverage, and insider trading activity.
        </p>
