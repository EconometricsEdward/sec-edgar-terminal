...
export const metadata: Metadata = {
  ...
  description:
    'Structured financial analysis for every U.S. public company. Income statement, balance sheet, cash flow, filing activity, material event radar, profitability bridge, balance sheet risk, cash conversion, and industry-aware ratios from SEC XBRL data.',
  alternates: {
    ...
    <>
      <div className="mb-6">
        ...
        <p className="text-xs text-stone-400 leading-relaxed max-w-3xl">
          ...
          material event radar, profitability bridge, balance sheet risk, cash conversion, and concept-level history (including restatements).
        </p>
      </div>
      ...
      <div className="border-2 border-dashed border-stone-800 p-12 text-center">
        ...
        <p className="text-stone-600 text-xs max-w-md mx-auto">
          ...
          with filing markers, material event radar, profitability bridge, balance sheet risk, cash conversion, and insider trading activity.
        </p>
