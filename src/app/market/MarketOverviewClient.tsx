...
const MarketFactorUniverse = dynamic(() => import('./MarketFactorUniverse'), { ssr: false, loading: () => <p role="status">Loading Factor Lab…</p> });
