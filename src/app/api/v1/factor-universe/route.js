...
export async function GET() {
  return Response.json({ schema_version: 'edgar.api-retirement.v1', error: 'Factor Universe v1 was retired with third-party price-derived analytics.', code: 'API_VERSION_RETIRED', retired: true, replacement: '/api/v2/factor-universe', documentation: '/market?tab=sectors' }, { status: 410, headers });
}
