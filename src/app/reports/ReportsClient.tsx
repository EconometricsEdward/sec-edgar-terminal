...
const MarketReportPreview = dynamic(() => import("./MarketReportPreview"));
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.builder} aria-labelledby="report-search-title">
        ...
        {kind === "market" && <div className={styles.marketIntro}><ChartNoAxesCombined size={28} aria-hidden="true" /><div><h3>The Market page, in a report</h3><p>Follow the same Market Briefing, CFTC Positioning and Sector Performance sections: business breadth, six macro market views, sector comparisons, industries and companies.</p><p>The PDF brings the briefing and sector profiles together. Excel includes the matching overview and complete available tables. Sector performance reflects reported business fundamentals.</p></div></div>}
      ...
      {report && <section className={styles.report} aria-labelledby="prepared-report-title">
        ...
        {report.kind === "market" && report.marketBriefing ? <MarketReportPreview report={report} /> : <>
