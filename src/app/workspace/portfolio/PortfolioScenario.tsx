    ...
    >
      ...
      {result.basis === "none" && !scenario.equalWeight && (
        <div className={styles.optIn}>
          <div>
            <strong>Your ticker list does not specify invested weights.</strong>
            <p>
              Explore with equal weights across the included positions. This
              assumption stays in this scenario and does not change your saved
              portfolio.
            </p>
          </div>
          <button
          ...
          <select
            ...
            onChange={(event) =>
              change({
                ...
                remainderShockPct: "0",
                targetCik: scenario.targetCik || result.issuers[0]?.cik || "",
                targetIndustry:
      ...
      <div className={styles.footer}>
        <details>
          ...
          <p>
            “pp” means percentage points of the whole portfolio. A 60% holding
            falling 20% contributes −12 percentage points.
          </p>
          <ul>
            {result.assumptions.map((assumption: string) => (
