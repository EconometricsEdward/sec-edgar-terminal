...
const FEATURE_GRID = [
  ...
  { icon: BarChart3, title: 'Financial Analysis', description: 'Income statement, balance sheet, cash flow, common-size views, SEC filing activity, material event radar, profitability bridge, earnings quality, growth durability, per-share economics, capital efficiency, balance sheet risk, cash conversion, capital allocation, and a source-linked analyst checklist across 10 fiscal years. Every value links to its source XBRL tag or filing on SEC.gov.', link: '/analysis/JPM', linkLabel: 'Analyze JPMorgan →' },
