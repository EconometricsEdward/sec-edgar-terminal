...
const FEATURE_GRID = [
  ...
  { icon: BarChart3, title: 'Financial Analysis', description: 'Income statement, balance sheet, cash flow, common-size views, capital allocation, and a source-linked analyst checklist across 10 fiscal years. Every value links to its source XBRL tag on SEC.gov.', link: '/analysis/JPM', linkLabel: 'Analyze JPMorgan →' },
  ...
  { icon: FileSearch, title: 'Disclosure Keyword Search', description: "Search any company's SEC filings for the exact risks, trends, or operating terms you care about. Evidence summaries and paragraph-level excerpts link directly to source filings, and you can compare up to 5 companies, scan curated sector universes, or run a bounded cross-sector Market Map.", link: '/disclosures', linkLabel: 'Search tariffs, AI, cyber risk →' },
];
