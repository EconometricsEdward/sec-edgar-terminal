...
const FEATURE_GRID = [
  ...
  { icon: BarChart3, title: 'Financial Analysis', description: 'Income statement, balance sheet, cash flow, common-size views, capital allocation, and calculated ratios across 10 fiscal years. Every value links to its source XBRL tag on SEC.gov.', link: '/analysis/JPM', linkLabel: 'Analyze JPMorgan →' },
