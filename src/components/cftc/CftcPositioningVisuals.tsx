...
type Props = { history: any; onGroupChange: (group: string) => void; onReportInspect?: (date: string) => void };
...
function PositioningVisuals({ history, onGroupChange, onReportInspect }: Props) {
