...
const DEFAULT_TAGS = {
  ...
  nonperformingLoans: [
    ...
    'FinancingReceivableNonaccrualExcludingAccruedInterest',
  ],
  ...
  htmSecuritiesAmortizedCost: [
    'DebtSecuritiesHeldToMaturityAmortizedCostAfterAllowanceForCreditLoss',
    'DebtSecuritiesHeldToMaturityExcludingAccruedInterestAfterAllowanceForCreditLoss',
    'HeldToMaturitySecurities',
  ],
  htmSecuritiesFairValue: [
    'DebtSecuritiesHeldToMaturityFairValue',
    'HeldToMaturitySecuritiesFairValue',
  ],
  noninterestBearingDeposits: ['NoninterestBearingDepositLiabilities'],
