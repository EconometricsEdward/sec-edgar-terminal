...
const GUIDES = {
  ...
  openingAccountsPayable: guide(
    "Amounts owed to suppliers as of the day before the selected reporting period starts.",
    "Compare with closing accounts payable to understand the change in supplier balances during the period.",
    "A later filing may report this opening balance in an earlier-year comparative column. Match the balance date, not the filing year.",
    '"accounts payable" OR "payment terms"',
    "notes",
    ["corporate"],
  ),
  openingInventory: guide(
    "Reported inventory as of the day before the selected reporting period starts.",
    "Read alongside closing inventory and cost of revenue to investigate inventory turnover and working capital.",
    "A later filing may report this opening balance in an earlier-year comparative column. Match the balance date, not the filing year.",
    'inventory OR inventories OR "cost of sales"',
    "notes",
    ["corporate"],
  ),
  openingReceivables: guide(
    "Reported current receivables as of the day before the selected reporting period starts, within the selected source concept's scope.",
    "Read alongside closing receivables and revenue to investigate collection timing and working capital.",
    "A later filing may report this opening balance in an earlier-year comparative column. Match the balance date, not the filing year, and check whether the concept includes more than trade receivables.",
  ...
  averageAssets: guide(
    "The arithmetic average of opening and closing total assets: (opening assets + closing assets) / 2.",
    "The opening balance is dated the day before the selected reporting period starts; the closing balance is dated its end.",
    "Both reported balances are required. This is not a daily average or a single closing balance; large changes within the period may be obscured.",
    '"total assets" OR acquisition OR disposal',
    "notes",
    ["corporate", "banking"],
  ),
  averageEquity: guide(
    "The arithmetic average of opening and closing book equity: (opening equity + closing equity) / 2.",
    "The opening balance is dated the day before the selected reporting period starts; the closing balance is dated its end.",
    "Both reported balances are required. This is not a daily average or a single closing balance; review the source ownership scope and share transactions during the period.",
    '"stockholders equity" OR "shareholders equity" OR "share repurchase"',
    "notes",
    ["corporate", "banking"],
  ),
  equityAssets: guide(
