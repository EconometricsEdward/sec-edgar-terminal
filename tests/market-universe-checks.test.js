...
test('audit panels render unavailable states and real counts without invented percentages',()=>{
  ...
  const html=renderToStaticMarkup(createElement(testModule.exports.FundamentalResearchChecks,props));
  ...
  const populated=renderToStaticMarkup(createElement(testModule.exports.FundamentalResearchChecks,props));
  assert.match(populated,/Higher changes outnumber lower changes at every tested band/);
  const beta=renderToStaticMarkup(createElement(testModule.exports.BetaResearchChecks,props));
